...
def two_stage_warp(raw_img, corner_indicials, canonical_corners, 
                   bubble_canonical_positions):
    """
    ...
    bubble_canonical_positions : list of (x, y) canonical bubble centers    
    
    Returns
    -------
    final_warped : image after two-stage correction
    """
    # Stage 1: Initial 4-corner homography (your existing approach)
    H, _ = cv2.findHomography(corner_indicials, canonical_corners)
    roughly_warped = cv2.warpPerspective(raw_img, H, 
